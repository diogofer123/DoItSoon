    ...
    class Callback @Inject constructor(private val database: Provider<TaskDatabase>,@ApplicationScope private val applicationScope: CoroutineScope) : RoomDatabase.Callback(){
        ...
        override fun onDestructiveMigration(db: SupportSQLiteDatabase) {
            ...
            applicationScope.launch {
                dao.insertTask(TaskItem("Tarefa",false))
                dao.insertTask(TaskItem("Levar as compras",false))
                dao.insertTask(TaskItem("Trabalhar na app",true))
                dao.insertTask(TaskItem("Comprar coisas",false))
